...
class OrderData:
    metro = ['Черкизовская', 'Комсомольская', 'Арбатская']
    user = [['Иванов', 'Иван', 'Иванович', random.choice(metro),'grey', f'+7{randint(0000000000, 9999999999)}'],
            ['Петров', 'Петр', 'Петрович', random.choice(metro), 'black', f'+7{randint(0000000000, 9999999999)}']]
